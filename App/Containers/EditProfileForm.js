...
class EditProfileForm extends React.Component {
  ...
  handlePressPost = () => {
    ...
    this.props.attemptProfilePost(name, email, phone, telegramId,
      faircoinAddress, longitude, latitude, uuid)
  }
  ...
  renderFaircoinAddressInput(faircoinAddress, editable) {
    if (AppConfig.FaircoinEnabled) {
      return ( <
        ...
        <
        Label > {
          I18n.t('Faircoin Address')
        } < /Label> <
        Input ref = 'faircoinAddress'
        value = {
          faircoinAddress
        }
        editable = {
        ...
        onChangeText = {
          this.handleChangeFaircoinAddress
        }
        numberOfLines = {
          8
        }
  ...
  render() {
    ...
    return ( <
      ...
      <
      Label > {
        I18n.t('Where do you offer your services:')
      } < /Label> <
      MapView style = {
        Styles.map
      }
